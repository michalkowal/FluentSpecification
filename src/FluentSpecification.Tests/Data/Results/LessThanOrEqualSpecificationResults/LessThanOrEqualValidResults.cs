...
{
    public class LessThanOrEqualValidResults : List<ExpectedSpecificationResult>
    {
        public LessThanOrEqualValidResults()
        {
            #region 2/2
            ...
            Add(new ExpectedSpecificationResult
                {
                    ...
                    {
                        FullTrace = "LessThanOrEqualSpecification<Int32>",
                        ShortTrace = "LessThanOrEqual"
                    },
            ...
            Add(new ExpectedSpecificationResult
                {
                    ...
                    Trace = new ExpectedSpecificationTrace
                    {
                        FullTrace = "LessThanOrEqualSpecification<Double>",
                        ShortTrace = "LessThanOrEqual"
                    },
                    FailedSpecificationsCount = 0,
                    Errors = new List<string>()
            ...
            Add(new ExpectedSpecificationResult
                {
                    ...
                    Trace = new ExpectedSpecificationTrace
                    {
                        FullTrace = "LessThanOrEqualSpecification<Boolean>",
                        ShortTrace = "LessThanOrEqual"
                    },
                    FailedSpecificationsCount = 0,
                    Errors = new List<string>()
            ...
            Add(new ExpectedSpecificationResult
                {
                    ...
                    Trace = new ExpectedSpecificationTrace
                    {
                        FullTrace = "LessThanOrEqualSpecification<String>",
                        ShortTrace = "LessThanOrEqual"
                    },
                    FailedSpecificationsCount = 0,
                    Errors = new List<string>()
            ...
            Add(new ExpectedSpecificationResult
                {
                    ...
                    Trace = new ExpectedSpecificationTrace
                    {
                        FullTrace = "LessThanOrEqualSpecification<DateTime>",
                        ShortTrace = "LessThanOrEqual"
                    },
                    FailedSpecificationsCount = 0,
                    Errors = new List<string>()
            ...
            Add(new ExpectedSpecificationResult
                {
                    ...
                    Trace = new ExpectedSpecificationTrace
                    {
                        FullTrace = "LessThanOrEqualSpecification<ComparableFakeType>",
                        ShortTrace = "LessThanOrEqual"
                    },
                    FailedSpecificationsCount = 0,
                    Errors = new List<string>()
            ...
            Add(new ExpectedSpecificationResult
                {
                    ...
                    Trace = new ExpectedSpecificationTrace
                    {
                        FullTrace = "LessThanOrEqualSpecification<ComparableInterFakeType>",
                        ShortTrace = "LessThanOrEqual"
                    },
                    FailedSpecificationsCount = 0,
                    Errors = new List<string>()
            ...
            Add(new ExpectedSpecificationResult
                {
                    ...
                    Trace = new ExpectedSpecificationTrace
                    {
                        FullTrace = "LessThanOrEqualSpecification<FakeType>",
                        ShortTrace = "LessThanOrEqual"
                    },
                    FailedSpecificationsCount = 0,
                    Errors = new List<string>()
            ...
            Add(new ExpectedSpecificationResult
                {
                    ...
                    Trace = new ExpectedSpecificationTrace
                    {
                        FullTrace = "LessThanOrEqualSpecification<Nullable<Int32>>",
                        ShortTrace = "LessThanOrEqual"
                    },
                    FailedSpecificationsCount = 0,
                    Errors = new List<string>()
